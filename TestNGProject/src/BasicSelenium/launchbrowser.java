...
public class launchbrowser {
	...
	public void login() {
		...
		if(str == "Select your departure and return flight from the selections below. Your total price will be higher than quoted if you elect to fly on a different airline for both legs of your travel.")
		{
		...
		List<WebElement> rows =dr.findElements(By.xpath("//table[@bgcolor='ffffff'][1]/tbody/tr")); //to import java.util
...
/*Webelememnts - button , textbox,links,radiobutton,dropdown,image,webtable,checkbox ,textarea */

/*locators - id,name,classname,tagname,xpath,link text,partial link text,css selector */
//unable to get the value for dropdowns having option tag only

//Xpath - reference of element on DOM
//tagname[@attname='attvalue'];
//(//table[@bgcolor='ffffff'])[1] if you find multiple occurrences of it 
